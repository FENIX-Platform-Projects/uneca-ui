...
define([
    ...
    'config/events',
    'config/config',
    '../../../../uneca-ui/src/config/profile/config',
    'fx-dashboard/start',
    'fx-filter/start',
    'fx-common/utils',
    'lib/utils',
    ...
    'jstree'
], function ($, _, EVT, C, PC, Dashboard, Filter, FxUtils, Utils, i18nLabels, template, dashboardTemplate, basesTemplate, LateralMenuConfig, CountrySummary, Handlebars) {
