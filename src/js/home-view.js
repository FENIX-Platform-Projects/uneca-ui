...
define([
   ...
   HomeView.prototype._dispose = function () {
    ...
    /*HomeView.prototype.initCharts= function() {
        ...
        this.$chart1.highcharts($.extend(true, {}, chartTemplate, {
            title: {
        ...
        this.$chart2.highcharts($.extend(true, {}, chartTemplate, {
            chart: {
                type: 'column'
            },
            title: {
        ...
        this.$chart3.highcharts($.extend(true, {}, chartTemplate, {
            title: {
        ...
        this.$chart4.highcharts($.extend(true, {}, chartTemplate, {
            chart: {
                type: 'column'
            },
            title: {
